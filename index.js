...
register("command", (...args) => {
  if (args[0] === "help") {
    ...
    ChatLib.chat(
      "&6/srdb &7 debug options for routes try &6/srdb help &7for more info!"
    );
    ChatLib.chat(
      "&6/route &7 route recording try &6/route help &7for more info!"
    );
    ChatLib.chat("&8&m-------------------------------------------------");
    ...
    ChatLib.chat(
      "&cUnknown command. &7Try &6/ea help &7for a list of commands"
    );
  }
})
